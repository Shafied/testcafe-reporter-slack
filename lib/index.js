...
var testpass = envs('TESTCAFE_SLACK_TESTPASS', ':heavy_check_mark:');
var testfail = envs('TESTCAFE_SLACK_TESTFAIL', ':heavy_multiplication_x:');
...
exports['default'] = function () {
    return {
        ...
        reportTestDone: function reportTestDone(name, testRunInfo) {
            ...
            var result = hasErr ? testfail : testpass;

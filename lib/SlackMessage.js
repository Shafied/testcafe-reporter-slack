...
var slackWebhook = _config2['default'].slackWebhook;
var slackChannel = _config2['default'].slackChannel;
var slackUsername = _config2['default'].slackUsername;
var loggingLevel = _config2['default'].loggingLevel;
var quietMode = _config2['default'].quietMode;
    ...
    _createClass(SlackMessage, [{
        ...
        value: function sendMessage(message) {
            ...
            this.slack.webhook(Object.assign({
                ...
                if (!quietMode) {
                    if (err) {
                        console.log('Unable to send a messages to slack');
